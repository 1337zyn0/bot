...
public class Mittwoch {
    ...
    public String getModus() {
        ...
        if (isBetween(time, LocalTime.of(0, 0),
            ...
            if (isBetween(time, LocalTime.of(0, 0),
                    LocalTime.of(0, 20))) {
                jetztigermodus = "Battle 100% 3v3";
            } else if (isBetween(time, LocalTime.of(0, 21),
                    LocalTime.of(1, 20))) {
                jetztigermodus = "Battle Royal Survivor 4v4";
            ...
            if (isBetween(time, LocalTime.of(5, 21),
                ...
                jetztigermodus = "Battle Royal Special 2v2";
                    ...
                    LocalTime.of(10, 20))) {
                jetztigermodus = "Battle Royal Survival 4v4";
            ...
            if (isBetween(time, LocalTime.of(18, 11),
                    LocalTime.of(20, 20))) {
                jetztigermodus = "Territory War at 19, Battle Royal Random " +
                        "3v3 " +
                        "at 20";
